...
csv_dataframe_temp = read.csv("hemo.csv",header = TRUE)

# Randomizing the data
csv_dataframe = csv_dataframe_temp[sample(nrow(csv_dataframe_temp)),]
...
train_data_size = round(data_size*(0.73))
...
pred = knn(training_set,testing_set,ground_truth[1:train_data_size],k=9)
...
NR_R_training = table(ground_truth[1:train_data_size])
NR_R_testing = table(ground_truth[test_data_start:data_size])
